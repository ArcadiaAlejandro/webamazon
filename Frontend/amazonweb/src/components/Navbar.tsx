...
import logo from "../assets/Amazon_logo.svg"; // Ruta relativa
const Navbar = () => {
  return (
    <div className="bg-green-900 text-white fixed top-0 left-0 w-full z-50 shadow-md">
      ...
      <div className="flex items-center justify-between px-6 py-2 text-sm">
        ...
        <div className="flex items-center space-x-4">
          <img src={logo} alt="Amazon Logo" className="h-6" />
        ...
        <div className="flex items-center space-x-4">
          <a className="text-gray-300 cursor-pointer"><Link to="/idioma">ES</Link></a>
          <Link to="/login"  className="text-gray-300 cursor-pointer">Hola, Identifícate</Link>
      ...
      <div className="flex items-center justify-between overflow-x-auto px-6 py-2 text-sm bg-green-800">
        ...
        <button className="cursor-pointer hover:border hover:text-white">
        ...
        <span className="cursor-pointer hover:border hover:text-white">
          Tarjetas de Regalo
        </span>
      </div>
    </div>
